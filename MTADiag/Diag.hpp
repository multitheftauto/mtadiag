...
namespace Diag
{
	...
	std::string      MTAVersion;
	std::string      MTAShortVersion;
	std::string      OriginalMTAVersion;
	bool             MTAUpdated;

	std::string      MTAVersionsInstalled[CUR_MTA_VERSIONS + 1]; // array to store paths of all MTA versions currently installed
	int              MTAVerChoice;                           // stores user's choice of which MTA version to diagnose

	std::string      PasteBinResult;                         // HTTP response

	bool             CompatRemoved1;                         // were any compatibility mode registry settings removed?
	bool             CompatRemoved2;                         // were any compatibility mode registry settings removed?
	bool             DXUpdated;                              // was DirectX updated by MTADiag?
